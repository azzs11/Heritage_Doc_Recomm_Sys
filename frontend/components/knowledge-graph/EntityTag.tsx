...
const TYPE_STYLES: Record<string, string> = {
  ...
  // plural variants returned by the API
  persons:       "bg-blue-100 text-blue-800 border-blue-200",
  locations:     "bg-green-100 text-green-800 border-green-200",
  organizations: "bg-purple-100 text-purple-800 border-purple-200",
...
export default function EntityTag({ entity }: Props) {
  ...
  return (
    <Link
      ...
      className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium border hover:opacity-75 transition-opacity ${style}`}
    >
      {entity.name}
